...
<body>
    ...
    <p>
        ...
        If you haven't requested this service, you should contact <a href="mailto:webmaster@bocchio.dev?subject=Unexpected site credentials recovery&body=Request made for e-mail account: <?php echo $email ?>">the WebMaster</a>.<br><br>
