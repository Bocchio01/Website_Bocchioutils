...
<body>
    ...
    <p>
        ...
        In caso contrario invece, clicca su <a href='https://bocchioutils.altervista.org/BWS/it/?action=ModifyPasswordEmail&email=<?php echo $email ?>'>questo link</a> e potrai generare una nuova password.<br><br>
